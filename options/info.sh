...
Isadmin=$(curl -sS https://raw.githubusercontent.com/daneshswara29/izin/main/ip | grep $MYIP | awk '{print $5}')
...
echo -e "\033[1;96m  Contact WA   : 082380835972 \e[0m"
echo -e "\033[1;96m  Telegram     : t.me/D_swara \e[0m"
#echo -e "\033[1;96m  Channel     : https://t.me/vpnreseller29 \e[0m"
